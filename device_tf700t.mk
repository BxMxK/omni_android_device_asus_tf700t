...
# gps config files
PRODUCT_COPY_FILES += \
    device/asus/tf700t/configs/gpsconfig.xml:system/etc/gps/gpsconfig.xml \
    device/asus/tf700t/configs/gps.conf:system/etc/gps.conf \
    device/asus/tf700t/configs/bt_vendor.conf:system/etc/bluetooth/bt_vendor.conf \
    device/asus/tf700t/configs/get-gps-lto:system/bin/get-gps-lto
